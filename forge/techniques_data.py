...
TECHNIQUES = {t.key: t for t in [
    ...
    # =============================================================================================
    #  LOT INJECTION/PROTOCOLE — classes d'attaque injection & protocole HTTP couramment utilisées en
    #  bug bounty / pentest et jusqu'ici absentes de Forge. Chacune SELF-DESCRIBING via `_k(...)` : UNE
    ...
    # =============================================================================================
    #  LOT AUTH-FLOW / RACE — classes d'attaque flux-d'authentification & concurrence couramment
    #  utilisées (courses sur code de récupération / refresh-token / device-code, faiblesses de flux
    #  OAuth redirect_uri/state) et jusqu'ici absentes de Forge. Chacune SELF-DESCRIBING via `_k(...)` :
    ...
    # =============================================================================================
    #  LOT RECON/EXPOSURE/TAKEOVER — classes de recon/exposition/takeover couramment utilisées
    #  (subdomain takeover, exposition d'actuator/framework, SSRF métadonnées cloud) et jusqu'ici
    #  absentes de Forge. Chacune SELF-DESCRIBING via `_k(...)` : UNE entrée + UN module @register =
