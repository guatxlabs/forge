...
seuil, restreinte à la même cible
...
NB : non exercé en CI (faiss/torch sont des dépendances lourdes, hors du cœur stdlib) ; pour
l'activer, installer ces deps dans l'environnement de Forge. Le code est isolé et testé en repli.
"""
import json
