...
Les modules réels (P2) enveloppent des outils existants : testeurs web one-off, recon,
access_control, détection d'origine, évasion via un service d'automatisation navigateur. Ils restent des OUTILS AUTONOMES — l'engine les orchestre, ne les possède pas.
