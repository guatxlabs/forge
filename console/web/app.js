...
function route() { let v = location.hash.slice(1) || 'overview'; if (!VIEWS_HAS(v)) v = 'overview'; if (v === 'admin' && !isAdmin()) v = 'overview'; if (v === 'tenants' && !tenancyAdmin()) v = 'overview'; showView(v); }
