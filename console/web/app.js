...
const VIEWS = {
  ...
  coverage: 'coverage', campaigns: 'campaigns', roe: 'roe', ledger: 'ledger', dashboards: 'dashboards',
};
const LOADERS = {
  overview: loadOverview, launch: loadLaunch, modules: loadModules, findings: loadFindings,
  coverage: loadCoverage, campaigns: loadCampaigns, roe: loadRoe, ledger: loadLedger, dashboards: loadDashboards,
};
let loadedOnce = {};
function showView(v) {
