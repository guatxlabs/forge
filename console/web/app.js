...
// =====================================================================================
function complianceOn() { return !!(ENTERPRISE && ENTERPRISE.compliance); }
function complianceAdmin() { return !!(complianceOn() && isAdmin()); }
...
async function cmpSetHold(hold) {
...
function route() { let v = location.hash.slice(1) || 'overview'; if (!VIEWS_HAS(v)) v = 'overview'; if (v === 'admin' && !isAdmin()) v = 'overview'; if (v === 'tenants' && !tenancyAdmin()) v = 'overview'; if (v === 'identity' && !identityAdmin()) v = 'overview'; if (v === 'compliance' && !complianceAdmin()) v = 'overview'; showView(v); }
