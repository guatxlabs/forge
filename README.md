...
python3 -m unittest discover -s tests -t .  # Python seul (1497 tests — compte MESURÉ : `Ran 1497 tests` / `OK (skipped=1)`)
...
## État (v0.0.1 — 1497 tests Python + 404 tests Rust passent, zéro réseau) — **P1 + P2 complets**
