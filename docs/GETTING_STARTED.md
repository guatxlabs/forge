...
python3 -m unittest discover -s tests -t .   # Python seul (1497 tests)
```
...
> `console/target/release/forge`. `make test` finit sur **`OK`** (1497 tests Python verts + 404 tests Rust,
